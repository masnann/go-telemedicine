...
func (_m *UserRepositoryInterface) DeleteUser(userID int64) error {
...
// FindListUser provides a mock function with given fields: req
func (_m *UserRepositoryInterface) FindListUser(req models.FindListUserRequest) ([]models.FindListUserResponse, error) {
	ret := _m.Called(req)

	if len(ret) == 0 {
		panic("no return value specified for FindListUser")
	}

	var r0 []models.FindListUserResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(models.FindListUserRequest) ([]models.FindListUserResponse, error)); ok {
		return rf(req)
	}
	if rf, ok := ret.Get(0).(func(models.FindListUserRequest) []models.FindListUserResponse); ok {
		r0 = rf(req)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]models.FindListUserResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(models.FindListUserRequest) error); ok {
		r1 = rf(req)
	} else {
		r1 = ret.Error(1)
	}
